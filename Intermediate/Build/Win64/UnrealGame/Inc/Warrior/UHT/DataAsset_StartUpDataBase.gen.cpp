...
struct Z_Construct_UClass_UDataAsset_StartUpDataBase_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ActivateOnGiveAbilities_MetaData[] = {
...
#endif // WITH_METADATA
	static const UECodeGen_Private::FClassPropertyParams NewProp_ActivateOnGiveAbilities_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_ActivateOnGiveAbilities;
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UDataAsset_StartUpDataBase_Statics::NewProp_ActivateOnGiveAbilities_Inner = { "ActivateOnGiveAbilities", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UClass, Z_Construct_UClass_UWarriorGameplayAbility_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDataAsset_StartUpDataBase_Statics::NewProp_ActivateOnGiveAbilities = { "ActivateOnGiveAbilities", nullptr, (EPropertyFlags)0x0024080000010001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataAsset_StartUpDataBase, ActivateOnGiveAbilities), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ActivateOnGiveAbilities_MetaData), NewProp_ActivateOnGiveAbilities_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDataAsset_StartUpDataBase_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDataAsset_StartUpDataBase_Statics::NewProp_ActivateOnGiveAbilities_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDataAsset_StartUpDataBase_Statics::NewProp_ActivateOnGiveAbilities,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Epic_Games_Warrior_Source_Warrior_Public_DataAssets_StartUpData_DataAsset_StartUpDataBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDataAsset_StartUpDataBase, UDataAsset_StartUpDataBase::StaticClass, TEXT("UDataAsset_StartUpDataBase"), &Z_Registration_Info_UClass_UDataAsset_StartUpDataBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataAsset_StartUpDataBase), 1646590444U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Epic_Games_Warrior_Source_Warrior_Public_DataAssets_StartUpData_DataAsset_StartUpDataBase_h_1221045866(TEXT("/Script/Warrior"),
	Z_CompiledInDeferFile_FID_Epic_Games_Warrior_Source_Warrior_Public_DataAssets_StartUpData_DataAsset_StartUpDataBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Epic_Games_Warrior_Source_Warrior_Public_DataAssets_StartUpData_DataAsset_StartUpDataBase_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
